...
\end{Def}
\begin{Lemma}
    Für eine Menge $\mathcal F\subseteq K[X]$ nicht-konstanter Polynome existiert ein Zerfällungskörper und ein Zerfällungskörper ist eindeutig bist auf $K$-Isomorphismus.
\end{Lemma}
\begin{proof}
