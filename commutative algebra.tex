...
\end{Kor}
\begin{proof}
    Es ist $K\to A/f^{-1}(\frakm)\to B/\frakm$ injektiv, da $B\frak m$ eine endliche Körpererweiterung nach Schwachen NstSatz. Dann sind $K\to A/f^{-1}(\frakm)\to B/\frakm$ alle ganz und damit $A/f^{-1}(\frakm)$ %TODO
\end{proof}
\begin{Bsp}
