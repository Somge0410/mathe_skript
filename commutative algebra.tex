...
\begin{Def} 
Sei \( \frakp\in \Spec R \). Dann ist \( \oht(\frakp) \) definiert als die Länge der absteigenden Ketten von 
Primidealen,
die bei \( \frakp \) beginnnen.
\end{Def}
\begin{Lemma}
Es ist \( \oht(\frakp)=\dim(R_\frakp)\) für jedes Primideal \( \frakp\in \Spec R\) und 
